    ...
    context "on #{os}" do
      ...
      describe 'with no custom parameters' do
        ...
        it 'should configure puppet' do
          ...
          should contain_puppet__config__main("autosign").with({'value' => '$confdir/autosign.conf { mode = 664 }'})
      ...
      describe "when autosign => true" do
        ...
        it 'should contain puppet.conf [main] with autosign = true' do
          should contain_puppet__config__main('autosign').with({'value' => 'true'})
        end
      end
      ...
      describe 'when autosign => $confdir/custom_autosign {mode = 664}' do
        ...
        it 'should contain puppet.conf [main] with autosign = $confdir/custom_autosign {mode = 664}' do
          should contain_puppet__config__main('autosign').with({'value' => '$confdir/custom_autosign {mode = 664}'})
        end
      end
